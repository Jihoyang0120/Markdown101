...
Markdown은 사용되는 환경에 따라 사용자에게 다르게 보여질 수 있으며, 문법의 표준이 없는 단점이 있으므로, 문서를 꾸미는 용도로는 부적절합니다. 쉽게 작성할 수 있고, 쉽게 수정할 수 있는 가벼운 언어라는 점을 비춰볼 때 메뉴얼을 작성하기 위한 간단한 문서작업에 사용하는 것이 좋을 것이라 생각됩니다.
